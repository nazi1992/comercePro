...
var config = {
     entry: {
      ...
      'cart':['./src/page/cart/index.js'],//购物车页
     ...
     output: {
         path: __dirname+'/dist/',
         publicPath:'dev' === WEBPACK_ENV?'/dist/':'//s.happymmal.com/mmall-fe/dist/',//访问文件的路径
     ...
     plugins:[
      ...
      new HtmlWebpackPlugin(getHtmlConfig('about','关于我们')),//订单支付页
